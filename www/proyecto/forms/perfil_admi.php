...
<body translate="no">
  ...
  <form>
    <fieldset id="fieldset-sign-up">
      ...
      <a class="next" type="submit" onclick="actualizar()">Guardar</a>
       <a class="next" id="btn" type="submit">Actualizar</a>
    </fieldset>
  </form>
...
<script>
  ...
  console.log(datos)
    ...
    type:"POST",
    data:datos,
    url:"../production/actualizar_admi.php",
    success:function(respueta){
      ...
      swal({
        title: 'Algo anda mal',
        text:   'No puedes usar este usuario, ya se encuentra registrado',
        icon:   'error',
      });
    }else if(respueta==2){
