...
<head>
  ...
  <title><?php echo "Hola" . " " .  $_SESSION['nombre']; ?></title>
...
<body translate="no">
      ...
      <nav id="sidenav">
        <div id="sidenav-header">
          <div id="profile-picture">
            <img src="https://www.gravatar.com/avatar/fa4df8540bab3cb38f7dfa60c6e0522c.png" />
          </div>
  <a href="#" id="profile-link" ><?php echo $_SESSION['nombre']; ?></a>
        ...
        <ul id="main-nav">
          ...
          <li>
            <a href="#" onclick="hola3()">
              <i class="fa fa-user-tie"></i>
              SUBIR
            </a>
          </li>
          <li>
            <a href="#" onclick="hola4()">
...
<script src="../librerias/jquery-3.4.1.min.js"></script>
  <script id="rendered-js">
    ...
    <script>
      function hola(){
        $('#content').load('perfil_admi.php');

      }
      function hola2(){
        $('#content').load('ver_clientesadmi.php');

      }
      function hola3(){
        $('#content').load('cargar_producto.php');

      }
      function hola4(){
        $('#content').load('agregar_personaadmi.php');
